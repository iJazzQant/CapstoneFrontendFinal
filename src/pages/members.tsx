  ...
  const teamMembers = [
    {
      name: "Justinn Alzona",
      role: "Web Developer",
      imageSrc: "/path/to/justinn.jpg" // Replace with actual image path
    },
    {
      name: "Kristan Domondon",
      role: "Animator/Artist",
      imageSrc: "/path/to/kristan.jpg" // Replace with actual image path
    },
    {
      name: "Simon Ducusin",
      role: "Game Developer/Programmer",
      imageSrc: "simon.webp" // Replace with actual image path
    },
    {
      name: "Aaron Flores",
      role: "Project Manager/Documenter",
      imageSrc: "aaron.webp" // Replace with actual image path
    },
    {
      name: "Mr. Ryan Richard Guadana",
      role: "Adviser",
      imageSrc: "/path/to/ryan.jpg" // Replace with actual image path
    }
  ];
